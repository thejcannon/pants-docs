...
!!! warning "Be careful with overlapping `source` fields"
...
Run [`pants list dir:`](../project-introspection.md) in the directory of the target generator to see all generated target addresses, and [`pants peek dir:`](../project-introspection.md) to see all their metadata.
...
!!! note "Tip: one BUILD file per directory"
    ...
    [`pants tailor ::`](../../getting-started/initial-configuration.md#5-generate-build-files) will automatically create targets that only apply metadata for the directory.
