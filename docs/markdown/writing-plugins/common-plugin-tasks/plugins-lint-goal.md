...
There are several ways for Pants to install your linter. See [Installing tools](../rules-api/rules-api-installing-tools.md). This example will use `ExternalTool` because there is already a pre-compiled binary for Shellcheck.
