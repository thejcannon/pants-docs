...
See [String interpolation using placeholder values](tagging-docker-images.md#string-interpolation-using-placeholder-values) for more information.
...
configuration (see [Configuring registries](tagging-docker-images.md#configuring-registries).
...
!!! note "Generating dynamic tags in a plugin"
    ...
    If you don't want to use the environment variable method described above, you'll need to write some custom plugin code. Don't hesitate to [reach out](../getting-help/index.md) for help with this.
...
See [Setting a repository name](tagging-docker-images.md#setting-a-repository-name) for placeholders specific to the `repository` field.
